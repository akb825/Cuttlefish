...
INSTANTIATE_TEST_CASE_P(TextureSaveTestTypes,
	...
	testing::Values(
		...
		TextureSaveTestInfo(Texture::Format::B4G4R4A4, {{Texture::Type::UNorm, unsupported}}),
		TextureSaveTestInfo(Texture::Format::A4R4G4B4, {{Texture::Type::UNorm, success}}),
...
INSTANTIATE_TEST_CASE_P(TextureSaveTestTypes,
	...
	testing::Values(
		...
		TextureSaveTestInfo(Texture::Format::A4R4G4B4, {{Texture::Type::UNorm, unsupported}}),
		TextureSaveTestInfo(Texture::Format::R5G6B5, {{Texture::Type::UNorm, success}}),
